  ...
  return (
    ...
    mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen'>
      <div
        ...
        xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0 h-[70px]
        bg-red-200/10 xl:h-max py-8 bg-white/10 backdrop-blur-sm
            ...
            >
              ...
              <div className='absolute pr-14 right-0 hidden xl:group-hover:flex '>
                <div className='bg-white relative flex text-primary items-center p-[6px] rounded-[3px]'>
                  <div className='text-[12] leading-none capitalize font-semibold '>{link.name}</div>
                  <div className=' border-l-8 border-y-transparent border-y-[6px]  absolute -right-2'></div>
                </div>
              </div>
              <div>
                {link.icon}
